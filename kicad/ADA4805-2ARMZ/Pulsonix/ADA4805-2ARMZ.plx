...
//550830/1073791/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADA4805-2ARMZ" (originalName "ADA4805-2ARMZ")
	...
	(compDef "ADA4805-2ARMZ" (originalName "ADA4805-2ARMZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VOUT1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "VOUT2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADA4805-2ARMZ"))
		...
		(attr "Manufacturer_Part_Number" "ADA4805-2ARMZ")
		(attr "Mouser Part Number" "584-ADA4805-2ARMZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADA4805-2ARMZ?qs=94CH1SeFPDbIgIDzbbE15w%3D%3D")
		(attr "Arrow Part Number" "ADA4805-2ARMZ")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ada4805-2armz/analog-devices?region=nac")
		(attr "Description" "Dual, 0.2 V/C Offset Drift, 105 MHz Low Power, Low Noise, Rail-to-Rail Amplifier")
		(attr "<Hyperlink>" "https://www.analog.com/ADA4805-2/datasheet")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "ADA4805-2ARMZ.stp")
