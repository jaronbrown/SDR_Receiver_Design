SamacSys ECAD Model
373232/1073791/2.50/16/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN74CBT3253CPWR" (originalName "SN74CBT3253CPWR")
	...
	(compDef "SN74CBT3253CPWR" (originalName "SN74CBT3253CPWR") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "1B4") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "1B3") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "1B2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "1B1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "1A") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "15" (pinName "2__OE") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "S0") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "2B4") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "2B3") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "2B2") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "2B1") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "2A") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN74CBT3253CPWR"))
		...
		(attr "Manufacturer_Part_Number" "SN74CBT3253CPWR")
		(attr "Mouser Part Number" "595-SN74CBT3253CPWR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN74CBT3253CPWR?qs=mE33ZKBHyE6I49B8KhfjUg%3D%3D")
		(attr "Arrow Part Number" "SN74CBT3253CPWR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sn74cbt3253cpwr/texas-instruments")
		(attr "Description" "Dual 1-Of-4 FET Multiplexer/Demultiplexer with -2 V Undershoot-Protection")
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/sn74cbt3253c")
		(attr "Height" "1.2 mm")
	)
